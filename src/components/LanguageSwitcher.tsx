...
const LanguageSwitcher = () => {
  ...
  const handleLanguageChange = useCallback(
    (event: React.ChangeEvent<HTMLSelectElement>) => {
      const selectedLanguage = event.target.value as typeof locale;
  ...
  return (
    <div className="border-b-[1.5px] border-b-black relative flex items-center gap-x-2.5 py-2 px-4">
      {locale === "en" ? (
        ...
        <FrFlag width={20} height={20} />
      )}
      <select
        className="focus:outline-none bg-transparent urbanist-font text-opacity-80 appearance-none px-1.5"
...
export function EnFlag(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      shapeRendering="geometricPrecision"
