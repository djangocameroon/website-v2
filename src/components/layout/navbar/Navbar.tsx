...
const Navbar = () => {
  ...
  const pagesWithSecondaryNavbar = [
    "/about",
    "/blog",
    "/projects",
    "/events",
    `/events/${usePathname().split("/").pop()}`,
  ];
  // const [nav, setNav] = useState(false)
  const tc = useTranslations("Common.navigation");
      ...
      >
        <div className="flex items-center font-medium justify-around lg:justify-between lg:w-[90%] lg:mx-auto">
          <div className="z-50 p-5 md:w-auto w-full flex justify-between">
            ...
            <div
              className={cn("text-3xl md:hidden", {
          ...
          >
            {navLinks.map((navLink, id) => {
              ...
              switch (navLink.label) {
                case "About":
                  navLinkLabel = tc("about");
                  break;
                case "Events":
                  navLinkLabel = tc("events");
                  break;
                case "Projects":
                  navLinkLabel = tc("projects");
                  break;
                case "Blog":
                  navLinkLabel = tc("blog");
                  break;
                default:
                  break;
              }
              return (
                  ...
                  className={cn(
                    ...
                    isActive ? "font-bold text-primary" : "font-medium",
                    {
                      ...
                      "hover:text-secondary/90":
                        !navBg && variant === "secondary" && !isActive,
                ...
                >
                  <Link
                    href={navLink.link}
                    className="py-7 text-lg inline-block urbanist-font"
                  >
                    {navLinkLabel}
                  </Link>
                </li>
            ...
            {isAuthenticated ? (
              <Button
                ...
                className={cn(
                  ...
                  {
                    "!border-secondary !text-secondary hover:!bg-secondary hover:!border-none hover:!text-white":
            ...
            <div className="py-5 flex flex-col gap-7 items-start justify-start px-10">
              {isAuthenticated ? (
                <Button
                  ...
                  outline
                  spacing={false}
                  className="duration-500 hover:scale-90 transition-all"
                >
                  {tc("SignOut")}
                </Button>
              ) : (
