  ...
  return (
    <div>
      <div id='#about' className='about-bg bg-image-styles'>
        <div className='flex justify-center flex-wrap md:flex-nowrap gap-12 items-center w-full h-full'>
          ...
          <div className='w-[50%]'>
            <h2 className='text-4xl leading-normal text-white font-bold mb-4'>
              Welcome to Django Cameroon, <br className='hidden md:block' />{' '}
              Where Collaboration Fuels <br className='hidden md:block' />{' '}
              Success
            </h2>
            <p className='text-white font-medium text-xl mb-4 leading-normal'>
